package com.example.bookstore.notification.events;

import com.example.bookstore.notification.domain.NotificationService;
import com.example.bookstore.notification.domain.OrderEventEntity;
import com.example.bookstore.notification.domain.OrderEventRepository;
import com.example.bookstore.notification.domain.models.OrderCancelledEvent;
import com.example.bookstore.notification.domain.models.OrderCreatedEvent;
import com.example.bookstore.notification.domain.models.OrderDeliveredEvent;
import com.example.bookstore.notification.domain.models.OrderErrorEvent;
...
class OrderEventHandler {
    private static Logger log = LoggerFactory.getLogger(OrderEventHandler.class);
