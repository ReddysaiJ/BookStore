...
public class ProductServiceClient {
    ...
    @CircuitBreaker(name = "catelog")
    @Retry(name = "catelog", fallbackMethod = "getProductByCodeFallback")
    ...
    Optional<Product> getProductByCodeFallback(String code, Throwable t) {
        log.info("catelog-service get product by code fallback: code:{}, Error: {} ", code, t.getMessage());
